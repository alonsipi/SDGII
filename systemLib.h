...
#define TIMEOUT_ACTUALIZA_JUEGO 1200
#define TIMEOUT_RAPIDO 1000 // Nivel difícil 1000 ms está la pelota por fila
#define TIMEOUT_MUY_RAPIDO 850 // Nivel muy difícil 850 ms está la pelota por fila
#define TIMEOUT_EXTREMO 700 // Nivel extremo 700 ms está la pelota por fila
...
#define FLAG_BOTON 			0x20 //servirá ademas para reanudar el juego
...
enum fsm_state {
	WAIT_START,
	WAIT_PUSH,
	WAIT_PAUSE, //nuevo estado de pausa
	WAIT_END};
