...
int main () {
	...
	fsm_trans_t arkanoPi[] = {
			...
			{ WAIT_PUSH, CompruebaPausaJuego, WAIT_PAUSE, PausaJuego },//CONFIGURAMOS LAS NUEVAS TRANSICIONES PARA LA PAUSA
			{ WAIT_PAUSE, CompruebaBotonPulsado, WAIT_PUSH, ReanudarJuego },// Y REANUDACION DEL JUEGO
