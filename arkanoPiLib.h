...
int CompruebaPausaJuego (fsm_t* this); 	//Hemos añadido esta funcion de transicion de la maquina de estados
...
void PausaJuego (fsm_t* this); //Hemos añadido esta función de acción de la maquina de estados
void ReanudarJuego (fsm_t* this); //Hemos añadido esta función de acción de la maquina de estados
